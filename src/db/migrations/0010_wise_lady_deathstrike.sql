...
ALTER TABLE "activity_logs" DROP CONSTRAINT "activity_logs_user_id_users_sync_write_id_fk";
--> statement-breakpoint
ALTER TABLE "attendees" DROP CONSTRAINT "attendees_user_id_users_sync_write_id_fk";
--> statement-breakpoint
ALTER TABLE "check_in_audit" DROP CONSTRAINT "check_in_audit_actor_user_id_users_sync_write_id_fk";
--> statement-breakpoint
ALTER TABLE "events" DROP CONSTRAINT "events_created_by_users_sync_write_id_fk";
--> statement-breakpoint
ALTER TABLE "guest_list_requests" DROP CONSTRAINT "guest_list_requests_requester_id_users_sync_write_id_fk";
--> statement-breakpoint
ALTER TABLE "guest_list_requests" DROP CONSTRAINT "guest_list_requests_reviewed_by_users_sync_write_id_fk";
--> statement-breakpoint
ALTER TABLE "proactive_guest_list" DROP CONSTRAINT "proactive_guest_list_added_by_users_sync_write_id_fk";
--> statement-breakpoint
ALTER TABLE "user_roles" DROP CONSTRAINT "user_roles_user_id_users_sync_write_id_fk";
--> statement-breakpoint
...
ALTER TABLE "check_in_audit" ADD CONSTRAINT "check_in_audit_actor_user_id_users_sync_id_fk" FOREIGN KEY ("actor_user_id") REFERENCES "neon_auth"."users_sync"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "events" ADD CONSTRAINT "events_created_by_users_sync_id_fk" FOREIGN KEY ("created_by") REFERENCES "neon_auth"."users_sync"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
